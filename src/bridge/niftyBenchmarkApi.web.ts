import type { BenchmarkDailyPoint } from "@mobile/utils/benchmarkTypes";

/** Same POST body/headers as mobile; routed via dev/prod proxy to avoid CORS. */
const NIFTY_TRI_URL = "/api/nifty/tri";
